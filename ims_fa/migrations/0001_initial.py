    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_platform', models.IntegerField(null=True, verbose_name='任务平台')),
                ...
                ('goods_price', models.DecimalField(decimal_places=2, max_digits=8, null=True)),
                ('goods_weight', models.FloatField(null=True)),
                ('goods_freight', models.DecimalField(decimal_places=2, max_digits=8, null=True)),
                ('task_commission', models.DecimalField(decimal_places=2, max_digits=8, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(max_length=255, upload_to='baoma/%Y%m')),
            ],
        ),
    ]
