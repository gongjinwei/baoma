# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-12-06 15:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ConsumeRecords',
            fields=[
                ('consume_id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('image_id', models.AutoField(primary_key=True, serialize=False)),
                ('path', models.ImageField(editable=False, max_length=255, upload_to='')),
                ('image_type', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(max_length=255, upload_to='baoma/%Y%m%d')),
                ('createtime', models.IntegerField(editable=False)),
            ],
            options={
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('realname', models.CharField(default='', max_length=45)),
                ('mobile', models.CharField(default='', max_length=45)),
                ('pay_type', models.SmallIntegerField(default=0)),
                ('order_num', models.CharField(default='', max_length=45)),
                ('amount', models.DecimalField(decimal_places=2, default=0.0, max_digits=8)),
                ('voucher_image', models.CharField(default='', max_length=255)),
                ('remark', models.CharField(default='', max_length=45)),
                ('operator_id', models.IntegerField(default=0)),
                ('createtime', models.IntegerField(editable=False)),
                ('operator_name', models.CharField(default='', max_length=55)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('merchant_state', models.IntegerField(default=10, editable=False)),
                ('money_balance', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=10)),
                ('createtime', models.IntegerField(editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_image', models.ImageField(editable=False, max_length=255, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store_url', models.CharField(default='', max_length=255)),
