...
class Publish(models.Model):
    ...
    pub_surplus = models.SmallIntegerField()
    pub_finished = models.SmallIntegerField()
    pub_state = models.IntegerField()
...
class Tasks(models.Model):
    ...
    goods_freight = models.DecimalField(max_digits=8, decimal_places=2)
    task_commission = models.DecimalField(max_digits=8, decimal_places=2)
    task_discount = models.FloatField()
    keyword = models.CharField(max_length=45)
    position = models.CharField(max_length=45)
    search_image = models.CharField(max_length=255)
    condition_image = models.CharField(max_length=255)
    taotoken = models.TextField()
    qrcode_image = models.CharField(max_length=255)
    staytime = models.IntegerField()
    add_favirate = models.IntegerField()
    add_cart = models.IntegerField()
    add_follow = models.IntegerField()
    share_taotoken = models.IntegerField()
    share_qrcode = models.IntegerField()
    task_attention = models.TextField()
    model_taoqi_min = models.SmallIntegerField()
    model_taoqi_max = models.SmallIntegerField()
    model_level = models.IntegerField()
    model_gender = models.IntegerField()
    model_age_min = models.IntegerField()
    model_age_max = models.IntegerField()
    model_area = models.CharField(max_length=255)
    model_height_min = models.IntegerField()
    model_height_max = models.IntegerField()
    model_weight_min = models.IntegerField()
    model_weight_max = models.IntegerField()
    model_shoe_min = models.IntegerField()
    model_shoe_max = models.IntegerField()
    model_designated = models.CharField(max_length=255)
    photograph_scene = models.CharField(max_length=45)
    photograph_collocation = models.CharField(max_length=45)
    photograph_images = models.CharField(max_length=255)
    photograph_attention = models.TextField()
    address_id = models.IntegerField()
    return_attention = models.TextField()
    task_state = models.IntegerField()
    createtime = models.IntegerField()
    updatetime = models.IntegerField()
    taoqi_filter = models.IntegerField()
    age_filter = models.IntegerField()
    height_filter = models.IntegerField()
    weight_filter = models.IntegerField()
    shoe_filter = models.IntegerField()
