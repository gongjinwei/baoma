...
class Tasks(models.Model):
    ...
    add_follow = models.IntegerField(null=True)
    share_taotoken = models.IntegerField(null=True)
    share_qrcode = models.IntegerField(null=True)
    task_attention = models.TextField(null=True)
    model_taoqi_min = models.SmallIntegerField(null=True)
    model_taoqi_max = models.SmallIntegerField(null=True)
    ...
    task_state = models.IntegerField(null=True)
    createtime = models.IntegerField(null=True)
    updatetime = models.IntegerField(null=True)
    taoqi_filter = models.IntegerField(null=True)
    age_filter = models.IntegerField(null=True)
